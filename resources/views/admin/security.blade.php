@extends('layouts.app')
@section('title','Security | Picastro')
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('StoreContent') }}">
                            @csrf
                        <div class="card-text">
                            <input type="hidden" name="page_name" value="Security">
                            <textarea class="ckeditor-classic form-control" rows="10" name="content">{!!$security->content ?? '' !!}</textarea>
                        </div>
