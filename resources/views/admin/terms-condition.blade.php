@extends('layouts.app')
@section('title','Terms and Conditions | Picastro')
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('StoreContent') }}">
                            @csrf
                        <div class="card-text">
                            <input type="hidden" name="page_name" value="Terms and Conditions">
                            <textarea class="ckeditor-classic form-control" rows="10" name="content">{!!$terms->content ?? '' !!}</textarea>
                        </div>
